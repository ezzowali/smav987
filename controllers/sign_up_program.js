...
var time = today.getDay()+"/"+today.getMonth()+"-"+today.getHours() + ":" + today.getMinutes() ;
  ...
  newUser.save(function (err) {
          ...
          تشكر لكم الأكاديمية السعودية للتطوع الصحي روح العطاء وحب الخير والمبادرة لخدمة ضيوف الرحمن، كما يسعدنا إبلاغكم بأنه تم استلام طلب انضمامكم للبرنامج الإعدادي للمتطوع الصحي، وسنوافيكم بالرد خلال الأيام القادمة إن شاء الله
